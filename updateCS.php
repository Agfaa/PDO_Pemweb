        ...
        <div>
            ...
            <main role="main">
                ...
                <form action="update.php" method="post">
                    ...
                    <input type="text" class="form-control"  value="<?= $data['customerNumber'] ?>" name="customerNumber" readonly>
                    </div>
                    <div>
                    <label>Customer Name</label>
                    <input type="text" class="form-control"  value="<?= $data['customerName'] ?>" name="customerName" required="required">
                    </div>
                    <div>
                    <label>Contact Last Name</label>
                    <input type="text" class="form-control"  value="<?= $data['contactLastName'] ?>" name="contactLastName" required="required">
                    </div>
                    <div>
                    <label>Contact First Name</label>
                    <input type="text" class="form-control"  value="<?= $data['contactFirstName'] ?>" name="contactFirstName" required="required">
                    </div>
                    <div>
                    <label>Phone</label>
                    <input type="text" class="form-control"  value="<?= $data['phone'] ?>" name="phone" required="required">
                    </div>
                    <div>
                    <label>Address Line 1</label>
                    <input type="text" class="form-control"  value="<?= $data['addressLine1'] ?>" name="addressLine1" required="required">
                    </div>
                    <div>
                    <label>Address Line 2</label>
                    <input type="text" class="form-control"  value="<?= $data['addressLine2'] ?>" name="addressLine2" >
                    </div>
                    <div>
                    <label>City</label>
                    <input type="text" class="form-control"  value="<?= $data['city'] ?>" name="city" required="required">
                    </div>
                    <div>
                    <label>State</label>
                    ...
                    <input type="text" class="form-control"  value="<?= $data['postalCode'] ?>" name="postalCode" required="required">
                    </div>
                    <div>
                    <label>Country</label>
                    <input type="text" class="form-control"  value="<?= $data['country'] ?>" name="country" required="required">
                    </div>
                    <?php
                    ...
                    <div>
                        ...
                        <input type="text" value="<?= $data['creditLimit'] ?>" name="creditLimit" required="required">
                    </div>
                    <?php endwhile; ?>
